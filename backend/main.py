...
from backend.api.ai_pricing import router as ai_pricing_router
...
from backend.api.disqualifications import router as disqualifications_router
from backend.api.excel_boq import router as excel_boq_router
...
from backend.api.partial_bids import router as partial_bids_router
...
app.include_router(disqualifications_router, prefix="/api")
app.include_router(excel_boq_router, prefix="/api")
app.include_router(partial_bids_router, prefix="/api")
