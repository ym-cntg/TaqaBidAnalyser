...
| `STAGE` | varchar(16) | 100% null across all rows — dead column |
...
| `email` | Populated only for a forwarded-platform identity; `NULL` for self-reported users — keeps the two namespaces from colliding |
