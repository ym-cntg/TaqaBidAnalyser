...
`user_id` gives 404, unknown target entity gives 400). Re-run every
prior feature's fixture-based test afterward to confirm no regression;
there is no CI to catch this automatically.
